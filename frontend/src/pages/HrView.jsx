      ...
      {error ? (
        ...
        <div className='employee_Block'>
          ...
          <section className="employee-details">
            ...
            <p><strong>Birthday:</strong> {formatDate(employee.birthday)}</p>
            ...
            <p><strong>Hired Date:</strong> {formatDate(employee.hired_date)}</p>
            <p><strong>Employment Status:</strong> {employee.employment_status}</p>
            <p><strong>Marital State:</strong> {employee.marital_state}</p>
                ...
                <ul>
                  {employee.dependents.map((dependent, index) => (
                    <li key={index}>
                      ...
                      <p><strong>age:</strong> {calculateAge(dependent.date_of_birth)}</p>
                      <p><strong>gender:</strong> {dependent.gender}</p>
                      {dependent.phone_number && (
                      <p><strong>phone Number:</strong> {dependent.phone_number}</p>
      )}
                    </li>
                  ))}
                </ul>
