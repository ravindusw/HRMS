...
router.get('/api/notification', (req, res) => {
    ...
    if (type) {
        filteredNotificationList = filteredNotificationList.filter(notification => notification.type === type);
    }

    if (status) {
        filteredNotificationList = filteredNotificationList.filter(notification => notification.status === status);
    }
